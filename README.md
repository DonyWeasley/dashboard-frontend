...
1. Clone โปรเจกต์
```bash
git clone https://github.com/DonyWeasley/dashboard-frontend.git
```
...
## 📌 Notes
โปรเจกต์นี้พัฒนาขึ้นเพื่อใช้ในการศึกษา โดยมีวัตถุประสงค์เพื่อช่วยให้ผู้ใช้งานสามารถจัดการข้อมูลรายจ่ายจากสลิปโอนเงินได้อย่างเป็นระบบ และลดความผิดพลาดจากการกรอกข้อมูลด้วยตนเอง
